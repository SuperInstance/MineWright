...
2. [Introduction: The RTS AI Challenge](#introduction-the-rts-ai-challenge)
3. [Classic RTS AI Era (1995-2005)](#classic-rts-ai-era-1995-2005)
4. [Core AI Techniques Used in Classic RTS](#core-ai-techniques-used-in-classic-rts)
5. [Modern RTS AI (2006-2025)](#modern-rts-ai-2006-2025)
6. [Extractable Patterns for Minecraft](#extractable-patterns-for-minecraft)
...
### 2. Age of Empires II (1999) - Resource Balancing Master
...
### 3. Command & Conquer Series - Unit Coordination
...
### 4. Warcraft III (2002) - Hero Management
...
public class HeroAI {
    ...
    private boolean shouldGoCreeping() {
        // Don't creep if hero is too low level
        if (hero.getLevel() >= 5) {
            return false;
        }
...
1. **"Investigation of the Effect of 'Fog of War' in the Prediction of StarCraft Strategy Using Machine Learning"** (2015)
   - [Zhangqiaokeyan](https://m.zhangqiaokeyan.com/journal-foreign-detail/0704066859305.html)
   - Analyzes fog of war impact on AI strategy prediction

2. **"Human-Like Build-Order Management in StarCraft to Win against Specific Opponent's Strategies"** (2015)
   - [Academic Conference Paper](https://m.zhangqiaokeyan.com/academic-conference-foreign_2015-3rd-international-conference-applied-computing-information_thesis/02051846566.html)
   - Build order optimization for countering specific strategies

3. **"Building Placement Optimization in Real-Time Strategy Games"** (ResearchGate, 2014)
   - [ResearchGate PDF](https://www.researchgate.net/publication/267268775_Building_Placement_Optimization_in_Real-Time_Strategy_Games)
   - Build order execution with wave training

4. **"Terrain Analysis in Real-Time Strategy Games: Choke Point Detection and Region Decomposition"**
   - 97% accuracy in identifying strategic bottlenecks in StarCraft maps
   - Enables AI to reason about terrain and plan attack routes

5. **"Integrating Fuzzy Integral and Heuristic Search for Unit Micromanagement in RTS Games"** (IEEE Conference, 2014)
   - Fuzzy integral + heuristic search for combat micro

### Game Sources

6. **StarCraft AI Scripting**
   - [Baidu Zhidao - StarCraft 1.08 AI](https://zhidao.baidu.com/question/1923478796523143787.html)
   - Build order scripts, attack_add, defense orders

7. **Command & Conquer Red Alert Source Code**
   - [CSDN - Red Alert AI Analysis](https://www.csdn.net/blog/Nirvana)
   - Team AI (CODE/TEAM.CPP), layered decision-making

8. **StarCraft 2 AI Tournament Results**
   - [Samsung SAIDA vs Facebook CherryPi (2018)](https://m.36kr.com/p/1722989608961)
   - Rule-based system defeated ML-based bot

9. **DeepMind AlphaStar**
   - [AlphaStar Analysis](https://m.163.com/dy/article/E6C1I1IH05118HA4.html)
   - Deep neural network architecture for StarCraft II

### Technical Articles

10. **Unity Influence Map Integration**
    - [CSDN - A* + Influence Maps](https://blog.csdn.net/qq_33419889/article/details/112345678)
    - Spatial representation of territorial control

11. **Game AI Design - Decision Maps**
    - [GameRes - Decision Maps](https://www.gameres.com/)
    - 2D arrays for resource tracking and strategic decisions

12. **"Utility AI in Game Development"**
    - [CSDN Blog](https://blog.csdn.net/wawa1203/article/details/109337835)
    - Weight-based scoring for game AI decisions

13. **Finite State Machines in Games**
    - [CSDN - FSM for Game AI](https://m.blog.csdn.net/Heroan1123/article/details/104038608)
