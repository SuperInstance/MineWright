...
public class SimpleEventBus implements EventBus {
    ...
    /**
     * Sorts subscribers by priority (descending - higher priority first).
     */
    private void sortSubscribers(CopyOnWriteArrayList<SubscriberEntry<?>> list) {
        // Use a simple comparator - priority is always present
