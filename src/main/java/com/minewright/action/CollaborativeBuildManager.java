...
public class CollaborativeBuildManager {
    ...
    public static class CollaborativeBuild {
        ...
        public CollaborativeBuild(String structureId, List<BlockPlacement> buildPlan, BlockPos startPos) {
            ...
            this.participatingForemen = ConcurrentHashMap.newKeySet();
            this.startPos = startPos;
            this.foremanToSectionMap = new ConcurrentHashMap<>();
         ...
         * Each quadrant is sorted BOTTOM-TO-TOP so each Foreman builds their quadrant from the ground up
         */
    ...
    /**
     * A section of the build that one Foreman works on (represents a spatial quadrant)
     */
    ...
    /**
     * Get the next block for a Foreman to place (each Foreman works on their own section)
     * Returns null if Foreman's section is complete
     */
    public static BlockPlacement getNextBlock(CollaborativeBuild build, String foremanName) {
        ...
        // Assign Foreman to a section if not already assigned
