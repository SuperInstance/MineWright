...
/**
 * Manages response templates for different personality archetypes and failure scenarios.
 *
 * <p>This class contains organized template methods for generating personality-specific
 * failure responses based on severity levels and failure types.</p>
 *
 * <p>Templates are organized by archetype:</p>
 * <ul>
 *   <li>Perfectionist - Focus on protocols and procedural correctness</li>
 *   <li>Worrier - Anxious, apologetic, seeks reassurance</li>
 *   <li>Stoic - Minimal emotion, focused on solutions</li>
 *   <li>Enthusiastic - Upbeat, optimistic, learns from mistakes</li>
 *   <li>Introverted - Quiet, brief responses</li>
 *   <li>Accommodating - Concerned with player feelings</li>
 *   <li>Direct - No-nonsense, action-oriented</li>
 *   <li>Innovator - Curious, sees failure as learning opportunity</li>
 *   <li>Balanced - Moderate responses across traits</li>
 * </ul>
 *
...
public class ResponseTemplateManager {
    ...
    /**
     * Generates a perfectionist response focused on procedural correctness.
     */
    public static String generatePerfectionistResponse(FailureResponseGenerator.FailureContext context) {
    ...
    /**
     * Generates a worrier response focused on anxiety and reassurance.
     */
    public static String generateWorrierResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
    ...
    /**
     * Generates a stoic response focused on minimal emotion and solutions.
     */
    public static String generateStoicResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        FailureResponseGenerator.FailureType type = context.getFailureType();
    ...
    /**
     * Generates an enthusiastic response focused on optimism and learning.
     */
    public static String generateEnthusiasticResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        int failureCount = context.getPreviousFailureCount();
    ...
    /**
     * Generates an introverted response focused on brevity.
     */
    public static String generateIntrovertedResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        FailureResponseGenerator.FailureType type = context.getFailureType();
    ...
    /**
     * Generates an accommodating response focused on player feelings.
     */
    public static String generateAccommodatingResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        FailureResponseGenerator.FailureType type = context.getFailureType();
    ...
    /**
     * Generates a direct response focused on action and results.
     */
    public static String generateDirectResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        FailureResponseGenerator.FailureType type = context.getFailureType();
    ...
    /**
     * Generates an innovator response focused on learning and discovery.
     */
    public static String generateInnovatorResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        FailureResponseGenerator.FailureType type = context.getFailureType();
    ...
    /**
     * Generates a balanced response with moderate traits.
     */
    public static String generateBalancedResponse(FailureResponseGenerator.FailureContext context) {
        int severity = context.getSeverity();
        FailureResponseGenerator.FailureType type = context.getFailureType();
        int failureCount = context.getPreviousFailureCount();
