 ...
 * registry.register("mine", (minewright, task, ctx) -&gt; new MineBlockAction(minewright, task));
 *
 * // Create an action
 * BaseAction action = registry.createAction("mine", minewright, task, context);
 *
...
public class ActionRegistry {
     ...
     * @param minewright      MineWright entity
     ...
     */
    public BaseAction createAction(String actionName, ForemanEntity minewright, Task task, ActionContext context) {
        if (actionName == null) {
