 ...
 *
 * <p>Implement this interface to add custom actions to MineWright AI.
 * The plugin system uses Java's ServiceLoader mechanism for discovery.</p>
 *
 * <p><b>Registration:</b> Create a file at:
 * {@code src/main/resources/META-INF/services/com.minewright.plugin.ActionPlugin}
 ...
 *         registry.register("dance", (minewright, task, ctx) -&gt; new DanceAction(minewright, task));
 *         registry.register("greet", (minewright, task, ctx) -&gt; new GreetAction(minewright, task));
 *     }
 * }
 * </pre>
 *
...
public interface ActionPlugin {
     ...
     *
     *     registry.register("smart_mine", (minewright, task, ctx) -&gt;
     *         new SmartMineAction(minewright, task, cache));
     * }
     * </pre>
     *
