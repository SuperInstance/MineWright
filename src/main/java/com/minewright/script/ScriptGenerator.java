...
public class ScriptGenerator {
    ...
    public static class GeneratorStats {
        ...
        private final AtomicInteger totalLatencyMs = new AtomicInteger(0);
        ...
        public void recordValidationFailure() { validationFailures.incrementAndGet(); }
        ...
        public double getAvgTokensPerCall() {
            ...
            return calls > 0 ? (double) totalTokensUsed.get() / calls : 0.0;
        }
        ...
        public String toString() {
            return String.format(
                ...
                getCacheHitRate(), getLLMCalls(), getAvgTokensPerCall(), getAvgLatencyMs(), getSuccesses(), getFailures()
            );
        }
    }
